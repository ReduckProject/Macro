...
f["选中斗转目标"] = function()
    if cdtime("斗转星移") == 0 then
        --nid = player("可选中", "视线可达", "内功:易筋经|凌海诀|笑尘诀|太玄经|焚影圣诀|紫霞功", "自己可视", "可视自己", "关系:敌对", "距离<40", "角度<10")
        nid = player("可选中", "视线可达", "内功:太玄经", "关系:敌对", "距离<40")
        --if nid == 0 then
        --    nid = player("可选中", "视线可达", "自己可视", "可视自己", "关系:敌对", "距离<35", "角度<10")
        --end
        if nid ~= 0 then
