...
function Main(g_player)
	...
	if counter % 100 == 0 then
		clickButton("Normal2/MY_Request/Scroll_Request/WndContainer_Request/WndWindow_Item/Wnd_Content/Btn_Accept/")
	end
	...
	if tnobuff("钟林毓秀") then
		cast("钟林毓秀")
	end

	if buff("商阳指") and buff("钟林毓秀") and buff("兰摧玉折") then
		cast("芙蓉并蒂")
		cast("玉石俱焚")
	end
